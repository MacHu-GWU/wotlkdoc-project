...
.. code-block:: python
    ...
    .aura 40851 [震怒] 提高造成的伤害 200%, 提高 300% 生命上限.
    .aura 58361 [莫格莱尼之力] 造成的所有伤害提高 500%, 生命上限提高 15,000 点, 每秒恢复 25% 的生命值.
    .aura 53642 [莫格莱尼之力] 使 150 码范围内的友军 造成的所有伤害提高 2000%, 生命上限提高 30,000 点, 每秒恢复 20% 的生命值.
...
.. code-block:: python
    ...
    .aura 54283 [法术暴击30%] 使目标的法术暴击几率提高 30%, 持续 30 分钟, 消耗 20 法力.
    .aura 54675 [法术暴击30%] 使目标的法术暴击几率提高 30%, 持续 30 分钟, 消耗 680 法力.
...
.. code-block:: python
    ...
    .aura 70900 [黑暗突变] 变形为僵尸, 使你造成的所有伤害提高 100%, 永久持续.
...
.. code-block:: python
    ...
    .aura 71780 [真言术: 盾] 吸收14,550点伤害, 持续30秒
    .aura 68032 [真言术: 盾] 吸收45,000点伤害, 持续30秒
    .aura 68034 [真言术: 盾] 吸收72,000点伤害, 持续30秒
    .aura 71781 [真言术: 盾] 吸收14,5500点伤害, 持续30秒
...
.. code-block:: python
    ...
    .aura 37075 [伤害增效] 受到的所有伤害+100%, 永久持续

    .aura 38091 [物理增效] 受到的奥术伤害+75%, 永久持续
    .aura 38087 [奥术增效] 受到的奥术伤害+100%, 永久持续
    .aura 38088 [火焰增效] 受到的奥术伤害+100%, 永久持续
    .aura 38089 [冰霜增效] 受到的奥术伤害+100%, 永久持续
    .aura 38090 [神圣增效] 受到的奥术伤害+100%, 永久持续
    .aura 38092 [暗影增效] 受到的奥术伤害+100%, 永久持续
    .aura 38086 [自然增效] 受到的奥术伤害+100%, 永久持续
...
.. code-block:: python
    ...
    .aura 37487 [鲜血治疗] 完全治疗自己, 但之后每 1 秒减少 4% 的生命值, 持续 10 秒. 瞬发无冷却.
...
.. code-block:: python
    ...
    .learn 48325 [符文护盾] 免疫一切伤害, 持续 30 秒, 施法时间 1 秒, 无冷却.
...
.. code-block:: python
    ...
    .learn 12843 [莫德雷斯之盾] 免疫所有伤害, 持续1分钟
    .learn 47748 [裂隙之盾] 免疫所有伤害, 但是昏迷, 持续45秒
