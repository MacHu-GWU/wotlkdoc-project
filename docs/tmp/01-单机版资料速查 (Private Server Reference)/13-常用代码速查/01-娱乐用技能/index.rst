...
.. code-block:: python
    ...
    .aura 62713 [铁枝精华] 物理伤害提高 50%, 永久持续, 可点击取消.
    .aura 62968 [明叶精华] 魔法伤害提高 50%, 永久持续, 可点击取消.
...
.. code-block:: python
    ...
    .aura 54516 [嗜血术] 使 20 码 内的所有友方目标的急速等级提高 35%, 持续 20 秒, 瞬发无冷却, 消耗 250 点法力
    .aura 58942 [龙之怒] 使 99 码 内的所有友方目标的急速等级提高 50%, 持续 30 秒, 瞬发无冷却
    .aura 35776 [加速] 光环效果, 使 25 码内的所有友方目标的急速等级提高 50%, 移动速度提高 200%, 持续 30 秒
    ...
    # ICC 炮艇战怪物升级 Buff
    .aura 71188 [升级1] 所有伤害提高 30%, 急速等级提高 20%
    .aura 71193 [升级2] 所有伤害提高 60%, 急速等级提高 40%
    .aura 77195 [升级3] 所有伤害提高 120%, 急速等级提高 80%

    .aura 62942 [符文坚韧] 生命上限提高 100%, 所有伤害提高 50%, 急速等级提高 50%
    .learn 57060 [加速] 使施法者的 攻击, 施法, 移动 速度提高 100%, 持续 15 秒, 瞬发无冷却.
...
.. code-block:: python
    ...
    # 注意, 这里的技能叠加都是相乘关系, 比如一个 +900% 的 buff 就是 10 倍, 另一个
    # +100% 的 buff 就是 2 倍, 叠加后就是 20 倍
    ...
    .aura 74865 [为了暗矛部落] 所有伤害+300%, 每秒回复 5% 法力和 5 怒气, 四无技能, 可点击取消.
    .aura 74501 [为了诺莫瑞根] 所有伤害+300%, 每秒回复 5% 法力和 5 怒气, 四无技能, 可点击取消.
    .aura 74719 [为了诺莫瑞根] 所有伤害+300%, 每秒回复 5% 法力和 5 怒气, 四无技能, 可点击取消.
...
.. code-block:: python
    ...
    .aura 53426 [舔伤口] 5 秒内恢复 100% 的生命
    .aura 53089 [狼人之血] 4 分钟内每 1 秒回复 2% 的生命和法力
    ...
    .aura 62519 [自然协调] 使你受到的治疗效果提高 8%, 可叠加 150 次, 永久持续,
