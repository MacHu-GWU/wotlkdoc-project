...
dir_example_before = Path("/Users/sanhehu/Documents/GitHub/wotlkdoc-project/docs/tmp/03-游戏指导 (Game Guide)-back/09-角色打造 (Char Build)/Talent")
dir_example_after = Path("/Users/sanhehu/Documents/GitHub/wotlkdoc-project/docs/tmp/03-游戏指导 (Game Guide)-back/09-角色打造 (Char Build)/Talent_after")
...
compress_image(
    in_path=Path("/Users/sanhehu/Documents/GitHub/wotlkdoc-project/docs/source/03-游戏指导-Game-Guide/09-角色打造-Char-Build/01-End-Game/02-圣骑士-防护/wotlk-paladin-pve-prot-end-game-off-tank.png"),
    out_path=Path("/Users/sanhehu/Documents/GitHub/wotlkdoc-project/docs/source/03-游戏指导-Game-Guide/09-角色打造-Char-Build/01-End-Game/02-圣骑士-防护/wotlk-paladin-pve-prot-end-game-off-tank-after.png")
)